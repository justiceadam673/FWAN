...
const CollectionsCard = ({ image, title, seller, rating, quantity, price }) => {
  return (
    <div className=' md:max-w-full lg:max-w-[379px] max-w-[162px] w-full h-fit md:h-[669px] rounded-[12.823px] md:rounded-[30px] border bg-[#FFF] shadow-[0px_4px_2px_0px_rgba(0,0,0,0.25)] p-[8px] md:p-[20px] border-[#8C8383] '>
      <img
        src={image}
        alt={title}
