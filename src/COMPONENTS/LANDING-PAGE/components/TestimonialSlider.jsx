...
const TestimonialSlider = () => {
  ...
  return (
    <div className='bg-[#E4DBDB] py-12 px-4' {...handlers}>
      <h2 className='text-[45px] font-semibold text-center mb-[28px] text-[#1E1E1E] font-[kodchasan]'>
        What Our Users Say
      </h2>
      ...
      <div className='relative max-w-6xl mx-auto'>
        ...
        <div className='flex justify-center gap-8 transition-all duration-500'>
          {[0, 1].map((offset) => {
            ...
            const { id, name, image, message } = testimonials[index];

            return (
              <div
                key={id}
                className='bg-white rounded-[2rem] shadow-md max-w-md p-6 flex flex-col justify-start items-start'
              >
