...
export default function SignUp() {
  ...
  return (
    <div className='min-h-screen bg-black flex items-center justify-center bg-gray-100 p-4'>
      <div className='bg-white rounded-lg shadow-md w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 overflow-hidden'>
        ...
        <div className='w-full p-6 md:p-10'>
          <div className='flex items-center mb-6'>
            <img
              src='./src/assets/signup-img/Vector.png'
              alt='FWAN Logo'
              className=' mr-2 w-[124px] h-[58px]'
            />
          ...
          <h2 className='text-[28px] font-bold text-black font-[Inter] leading-none h-[58px]'>
            Create Account
          </h2>
          <p className='text-sm text-gray-600 mb-[20px] px-[96] py-[97]'>
          ...
          <form className='space-y-4'>
            ...
            <div className='flex justify-center space-x-4'>
              <img
                src='./src/assets/signup-img/jam_apple-circle.png'
                alt='Google'
              ...
              <img
                ...
                alt='Facebook'
                className='./src/assets/signup-img/flat-color-icons_google.png'
              />
              <img
                src='./src/assets/signup-img/Group (3).png'
                alt='Twitter'
                className='h-5 cursor-pointer'
              />
            </div>
            <p className='text-sm text-center text-[#000000] mt-4'>
              ...
              <a
                href='/signin'
                className='text-[#095C32] font-medium hover:underline'
              >
                Sign In
              </a>
            </p>
